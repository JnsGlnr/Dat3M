...
.debug_frame:
        ...
        /*004c*/ 	.byte	0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x04, 0x00, 0x00, 0x00, 0x04, 0x30, 0x00
...
.text._Z6kernelPiS_S_:
        ...
        /*0070*/                   IMAD.WIDE R4, R9, R6, c[0x0][0x168] ;
        /*0080*/                   STG.E.SYS [R2], R9 ;
        /*0090*/                   LDG.E.SYS R5, [R4] ;
        /*00a0*/                   IMAD.WIDE R6, R9, R6, c[0x0][0x170] ;
        /*00b0*/                   STG.E.SYS [R6], R5 ;
        /*00c0*/                   EXIT ;
.L_x_0:
        /*00d0*/                   BRA `(.L_x_0);
        /*00e0*/                   NOP;
