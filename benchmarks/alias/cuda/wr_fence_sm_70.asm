...
.debug_frame:
        ...
        /*005c*/ 	.byte	0x00, 0x00, 0x0c, 0x81, 0x80, 0x80, 0x28, 0x00, 0x04, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
.text._Z6kernelPiS_S_:
        ...
        /*0020*/                   S2R R7, SR_CTAID.X ;
        /*0030*/                   MOV R6, 0x4 ;
        /*0040*/                   S2R R0, SR_TID.X ;
        /*0050*/                   IMAD R7, R7, c[0x0][0x0], R0 ;
        /*0060*/                   IMAD.WIDE R2, R7, R6, c[0x0][0x160] ;
        /*0070*/                   IMAD.WIDE R4, R7, R6, c[0x0][0x168] ;
        /*0080*/                   STG.E.SYS [R2], R7 ;
        /*0090*/                   MEMBAR.SC.GPU ;
        /*00a0*/                   ERRBAR;
        /*00b0*/                   CCTL.IVALL ;
        /*00c0*/                   LDG.E.SYS R5, [R4] ;
        /*00d0*/                   IMAD.WIDE R2, R7, R6, c[0x0][0x170] ;
        /*00e0*/                   STG.E.SYS [R2], R5 ;
        /*00f0*/                   EXIT ;
.L_x_0:
        /*0100*/                   BRA `(.L_x_0);
        /*0110*/                   NOP;
