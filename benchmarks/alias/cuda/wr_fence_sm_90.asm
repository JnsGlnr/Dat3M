...
.debug_frame:
        ...
        /*004c*/ 	.byte	0x80, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x38, 0x00, 0x00, 0x00, 0x0c, 0x81, 0x80
        /*005c*/ 	.byte	0x80, 0x28, 0x00, 0x04, 0x3c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
.text._Z6kernelPiS_S_:
        ...
        /*0010*/                   LDC R7, c[0x0][RZ] ;
        /*0020*/                   S2UR UR4, SR_CTAID.X ;
        /*0030*/                   ULDC UR5, c[0x0][0x18c] ;
        /*0040*/                   S2R R0, SR_TID.X ;
        /*0050*/                   ISETP.NE.U32.AND P0, PT, RZ, UR5, PT ;
        /*0060*/                   LDC.64 R2, c[0x0][0x210] ;
        /*0070*/                   LDC.64 R4, c[0x0][0x218] ;
        /*0080*/                   IMAD R7, R7, UR4, R0 ;
        /*0090*/                   ULDC.64 UR4, c[0x0][0x208] ;
        /*00a0*/                   IMAD.WIDE R2, R7, 0x4, R2 ;
        /*00b0*/                   IMAD.WIDE R4, R7, 0x4, R4 ;
        /*00c0*/                   STG.E desc[UR4][R2.64], R7 ;
        /*00d0*/               @P0 BRA `(.L_x_0) ;
        /*00e0*/                   MEMBAR.ALL.CTA ;
        /*00f0*/                   MEMBAR.SC.SYS ;
        /*0100*/                   ERRBAR;
...
.L_x_0:
        ...
        /*0180*/                   CCTL.IVALL ;
.L_x_1:
        /*0190*/                   LDG.E R5, desc[UR4][R4.64] ;
        /*01a0*/                   LDC.64 R2, c[0x0][0x220] ;
        /*01b0*/                   IMAD.WIDE R2, R7, 0x4, R2 ;
        /*01c0*/                   STG.E desc[UR4][R2.64], R5 ;
        /*01d0*/                   EXIT ;
.L_x_2:
        /*01e0*/                   BRA `(.L_x_2);
        /*01f0*/                   NOP;
