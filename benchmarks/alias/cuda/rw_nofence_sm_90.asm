...
.debug_frame:
        ...
        /*004c*/ 	.byte	0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x40, 0x00, 0x00, 0x00, 0x04, 0x04, 0x00
...
.text._Z6kernelPiS_S_:
        ...
        /*00a0*/                   LDG.E R2, desc[UR4][R2.64] ;
        /*00b0*/                   IMAD.WIDE R4, R9, 0x4, R4 ;
        /*00c0*/                   IMAD.WIDE R6, R9.reuse, 0x4, R6 ;
        /*00d0*/                   STG.E desc[UR4][R4.64], R9 ;
        /*00e0*/                   IADD3 R11, R9, R2, RZ ;
        /*00f0*/                   STG.E desc[UR4][R6.64], R11 ;
        /*0100*/                   EXIT ;
.L_x_0:
        /*0110*/                   BRA `(.L_x_0);
        /*0120*/                   NOP;
