...
.debug_frame:
        ...
        /*004c*/ 	.byte	0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x04, 0x00, 0x00, 0x00, 0x04, 0x30, 0x00
        /*005c*/ 	.byte	0x00, 0x00, 0x0c, 0x81, 0x80, 0x80, 0x28, 0x00, 0x04, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
.text._Z6kernelPiS_S_:
        ...
        /*0070*/                   LDG.E R2, [R2.64] ;
        /*0080*/                   ISETP.NE.U32.AND P0, PT, RZ, c[0x0][0x128], PT ;
        /*0090*/                   IMAD.WIDE R4, R9, R6, c[0x0][0x168] ;
        /*00a0*/                   IMAD.WIDE R6, R9.reuse, R6, c[0x0][0x170] ;
