...
.debug_frame:
        ...
        /*004c*/ 	.byte	0x80, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x44, 0x00, 0x00, 0x00, 0x0c, 0x81, 0x80
        /*005c*/ 	.byte	0x80, 0x28, 0x00, 0x04, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
.text._Z6kernelPiS_S_:
        ...
        /*0030*/                   ULDC UR6, c[0x0][0x18c] ;
        /*0040*/                   S2R R0, SR_TID.X ;
        /*0050*/                   LDC.64 R2, c[0x0][0x210] ;
        /*0060*/                   LDC.64 R4, c[0x0][0x218] ;
        /*0070*/                   LDC.64 R6, c[0x0][0x220] ;
        /*0080*/                   IMAD R9, R9, UR4, R0 ;
        /*0090*/                   ULDC.64 UR4, c[0x0][0x208] ;
        /*00a0*/                   IMAD.WIDE R2, R9, 0x4, R2 ;
        /*00b0*/                   LDG.E R2, desc[UR4][R2.64] ;
        /*00c0*/                   ISETP.NE.U32.AND P0, PT, RZ, UR6, PT ;
        /*00d0*/                   IMAD.WIDE R4, R9, 0x4, R4 ;
        /*00e0*/                   IMAD.WIDE R6, R9.reuse, 0x4, R6 ;
        /*00f0*/                   IADD3 R11, R9, R2, RZ ;
        /*0100*/               @P0 BRA `(.L_x_0) ;
        /*0110*/                   MEMBAR.ALL.CTA ;
        /*0120*/                   MEMBAR.SC.SYS ;
        /*0130*/                   ERRBAR;
...
.L_x_0:
        ...
        /*01b0*/                   CCTL.IVALL ;
.L_x_1:
        /*01c0*/                   STG.E desc[UR4][R4.64], R9 ;
        /*01d0*/                   STG.E desc[UR4][R6.64], R11 ;
        /*01e0*/                   EXIT ;
.L_x_2:
        /*01f0*/                   BRA `(.L_x_2);
        /*0200*/                   NOP;
